...
function Privacypolicy() {
    return (
        <div className='privacy'>
            ...
            <img className='img' src="https://storylineonline.net/wp-content/uploads/2017/05/privacy-policy.jpg" alt="privacy policy" />
            <p>Your privacy is important to us. As a 501(c)(3) organization, we are not subject to rules set forth in the Children’s Online Privacy Protection Act (COPPA), but we are still committed to providing its protections to our users. Here are some ways that your information may be used on this site.
